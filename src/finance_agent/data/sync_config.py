...
def build_backtest_scheduler_jobs(config: DataSyncConfig) -> list[JsonDict]:
    ...
    return [
        {
            "name": "analytics.strategy.walk_forward.weekly",
            ...
            "depends_on": ["ashare.bars.1d.close_final"],
            "params": {
                "sync_task_type": "analytics.strategy.walk_forward.weekly",
                "strategy": "strategy_walk_forward_v2",
                "universe_id": "universe:merged:ashare:recommendation",
                "strategy_id": "strategy:ashare:adaptive_v1",
                "years": 5,
                "score_mode": "point_in_time",
                "topn": 20,
                "rebalance": "weekly",
        ...
        {
            "name": "analytics.strategy.forward_settlement.daily",
            "job_type": "backtest_run",
            "group": "analytics",
            "enabled": True,
            ...
            "depends_on": ["ashare.bars.1d.close_final"],
            "params": {
                "sync_task_type": "analytics.strategy.forward_settlement.daily",
        ...
        {
            "name": "analytics.strategy.validation_gate",
            "job_type": "backtest_run",
            "group": "analytics",
            "enabled": True,
            "interval_seconds": 24 * 60 * 60,
            ...
            "timezone": "Asia/Shanghai",
            "market": "ashare",
            "depends_on": ["analytics.strategy.forward_settlement.daily"],
            "params": {
                "sync_task_type": "analytics.strategy.validation_gate",
                "strategy": "strategy_validation_gate",
                "universe_id": "universe:merged:ashare:recommendation",
                "strategy_id": "strategy:ashare:adaptive_v1",
                "years": 1,
                "score_mode": "persisted_metrics",
                "topn": 20,
                "rebalance": "daily",
                "timeframe": (ashare_config.timeframes or ["1d"])[0],
            },
