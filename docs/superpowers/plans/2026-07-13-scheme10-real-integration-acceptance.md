...
> 2026-07-15 最终收口：第四十三、四十四批均 500/500 `available`；第四十五批 `001735` 瞬时超时后单标的重试成功；第四十六批剩余 489/489 `available`。数据库最终为 25,412,199 条净值事实、覆盖 20,595 只，水位为 20,595 `available`、9 `unavailable`，从未尝试和非 `available` 事实均为 0。生产 resolver 只剩 32 只已完整重采但仍缺中间年份的结构性源缺口；与 9 只终态无历史合计 41/20,604，例外率约 0.20%，低于 5%。清单、水位和重跑证据已登记，步骤 3 标记完成，不放宽中间整年缺口语义，也不宣称零缺口。
