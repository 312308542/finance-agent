...
| Finance Memory | 投资假设、建议理由、用户采纳情况、复盘结论、风险偏好、观察池变更原因 | `decision_logs`、`assistant_memories`、`review_tasks`、`asset_theses`、`memory_embeddings`、GraphStore | 作为金融建议的可审计上下文和长期业务记忆 |
